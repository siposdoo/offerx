    ...
    <div class="vx-row">
      ...
      <div class="vx-col w-full lg:w-1/2 mb-base">
        <vx-card slot="no-body" class="text-center bg-primary-gradient greet-user">
          ...
          <h1 class="mb-6 text-white">Pozdrav {{ activeUserInfo.displayedName }},</h1>
          <p class="xl:w-3/4 lg:w-4/5 md:w-2/3 w-4/5 mx-auto text-white">Koristite OFFER-X da unapredite i olakšate svoje poslovanje.</p>
        </vx-card>
      </div>
